...
<form name="data" action="deptlist.php" method="post" class="popup-form">
<script>
...
<select class=" form-control form-white dropdown" name="dept" REQUIRED>
    <option value="" disabled selected>Department</option>
    <option id="civil" class="color"  value="Civil Engineering">Civil Engineering</option>

...
<body>
	...
	<div class="preloader">
		<img src="img2/pie.gif" alt="Preloader image">
	</div>
	<nav class="navbar">
		<div class="container">
  ...
  <div class="w3-third w3-container"><br><br>
  <p><b>Co-Patron</b></p>

  <ul class="w3-ul w3-card-4">
    <li class="w3-padding-16">
      <img src="pics/principal.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. K.B. Madhu Sahu </span><br>
      <h4>Principal, AITAM</h4>
    </li>
  </ul>
  <br>
 <p><b>Convener</b></p>
   <ul class="w3-ul w3-card-4">
    <li class="w3-padding-16">
      <img src="pics/ecehod.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr.G.Sateesh Kumar </span><br>
      <h4>HOD, ECE</h4>
    </li>
  </ul><br>
   <p><b>Co-Conveners</b></p>
   <ul class="w3-ul w3-card-4">
    <li class="w3-padding-16">
      <img src="pics/yramesh.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. Y.Ramesh  </span><br>
      <h4>Associate Professor, CSE</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/chkannam.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. Ch.Kannam Naidu </span><br>
      <h4>Associate Professor, Civil</h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/chkrishna.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. Ch.Krishna Rao </span><br>
      <h4>Associate Professor, EEE</h4>
    </li> 
  </ul>
   <br>
   ...
   <ul class="w3-ul w3-card-4">
    <li class="w3-padding-16">
      <img src="pics/vishnu.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. D. Vishnu Murty</span><br>
      <h4>Dean(Admin), TEQIP Coordinator</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/asr.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. A.S. Srinivasa Rao </span><br>
      <h4>Dean, Finishing School</h4>
    </li>  
	<li class="w3-padding-16">
      <img src="pics/hari.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. N. Hari Babu </span><br>
      <h4>Dean, R & D</h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/csehod.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. G.S.N. Murty  </span><br>
      <h4>HOD, CSE</h4>
    </li> 
    <li class="w3-padding-16">
      <img src="pics/ithod.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. B.V. Ramana </span><br>
      <h4>HOD, IT</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/mechod.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. C.J.Rao </span><br>
      <h4>HOD, MEC </h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/eeehod.gif" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. D. Vijay Kumar </span><br>
      <h4>HOD, EEE</h4>
    </li> 
    <li class="w3-padding-16">
      <img src="pics/civhod.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. M. Murali </span><br>
      <h4>HOD, CIVIL</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/vasanthi.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. G. Vasanthi </span><br>
      <h4>HOD, BS&H</h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/balaram.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr. B. Balaram </span><br>
      <h4>HOD, MBA</h4>
    </li> 
    <li class="w3-padding-16">
      <img src="img_avatar2.png" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Prof. M.J. Manmadha Rao  </span><br>
      <h4>Asso.Dean, Student Affair</h4>
    </li>
    <li class="w3-padding-16">
      <img src="img_avatar5.png" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr.Ch.Ravi Kumar </span><br>
      <h4>Associate Dean, IQAC</h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/chramesh.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Dr.Ch.Ramesh  </span><br>
      <h4>Associate Dean, IQAC</h4>
    </li> 
  </ul>
 ...
 <br>
   ...
   <ul class="w3-ul w3-card-4">
    <li class="w3-padding-16">
      <img src="pics/dvln.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. D.V.L.N.Sastry 




</span><br>
      <h4>Asst. Professor, ECE</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/prabhakar.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. T.Prabhakar Rao</span><br>
      <h4>Sr.Asst. Professor, CSE</h4>
    </li>  
	<li class="w3-padding-16">
      <img src="pics/iram.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. I.Ramesh</span><br>
      <h4>Asst. Professor, EEE</h4>
    </li>  
    <li class="w3-padding-16">

      <img src="pics/klr.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. K.Laxmana Rao </span><br>
      <h4>Asst. Professor, MEC </h4>
    </li> 
    <li class="w3-padding-16">
      <img src="pics/manoj.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Mr. P.Manoj Kumar </span><br>
      <h4>Asst. Professor, CIVIL</h4>
    </li>
    <li class="w3-padding-16">
      <img src="pics/chsrinivas.jpg" class="w3-left w3-circle w3-margin-right" style="width:60px">
      <span class="w3-xlarge">Sri. Ch. Srinivasa Rao </span><br>
      <h4>Asst. Professor, IT</h4>
    </li>  
...
<br><br>
	...
	<section class="section section-padded blue-bg"><br><br>
...
<div data-u="slides" style="cursor: default;background-color:#00aaff; position: relative; top: 0px; left: 0px; width: 1300px; height: 400px; overflow: hidden;">
<div data-p="112.50">
<div class="item text-center">
							<i class="icon fa "></i>
							<h2 class="white light">SPONSOR</h2>
...
<div class="item text-center">
							<i class="icon fa "></i>
							<h2 class="white light">EVENT PARTNER</h2>

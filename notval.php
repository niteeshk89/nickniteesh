	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="home.php"><img src="aspire.png" data-active-url="aspire.png" width="50px" alt=""></a>
				</div>
...
<center><h2>YOU HAD ALREADY REGISTERED FOR THIS EVENT</h2></center>
